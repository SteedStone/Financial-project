...
print(calculs.gestion_fichier.data.head())
...
#Colonne S T U  
counter = 1
while(ColonneD[counter] < Duree_repracing_anne) : 
...
#Scan des nombres de BloomBerg
noms_colonnes_reels = data.columns
#print("Noms de colonnes réels :", noms_colonnes_reels)
debut_lignes = 8
fin_lignes = 25
debut_colonnes = 2
fin_colonnes = 4
